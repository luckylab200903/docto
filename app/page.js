      ...
      <section className="relative overflow-hidden py-32">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 lg:pl-12 xl:pl-24">
              <Badge
                variant="outline"
            ...
            <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden bg-black flex items-start justify-center">
              <Image
                src="/banner2.png"
